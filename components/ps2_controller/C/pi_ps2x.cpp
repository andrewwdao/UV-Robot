...
#define CTRL_BYTE_DELAY  70   //us
#define CTRL_CLK         70   //us
...
byte begin_frame[5]    = {0x01,0x42,0x00,0x00,0x00};

// static byte enter_config[]     = {0x01,0x43,0x00,0x01,0x00};
byte enter_config[5]     = {0x01,0x43,0x00,0x01,0x00};
// Once in config / escape mode, all packets will have 9 bytes (6 bytes of command / data after the header).
byte type_read[9]        = {0x01,0x45,0x00,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A};
byte set_mode_analog[9]  = {0x01,0x44,0x00,0x01,0x03,0x00,0x00,0x00,0x00};
byte set_mode_digital[9] = {0x01,0x44,0x00,0x00,0x03,0x00,0x00,0x00,0x00};
byte enable_pressure[9]  = {0x01,0x4F,0x00,0xFF,0xFF,0x03,0x00,0x00,0x00};
byte enable_rumble[9]    = {0x01,0x4D,0x00,0x00,0x01,0xFF,0xFF,0xFF,0xFF};
byte exit_config[9]      = {0x01,0x43,0x00,0x00,0x5A,0x5A,0x5A,0x5A,0x5A};
